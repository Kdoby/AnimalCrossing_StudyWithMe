...
import { getVideosEmbed } from '../../../services/embed/videoService';
import { queryKeys } from '../../../services/queryKeys';
import { DURATIONS } from '../../../constant/durations';
import { useAudioList } from '../../../hooks/useAudioList';

const FALLBACK_VIDEOS = [
  { id: 1, title: '뽀야미', animalName: '뽀야미', youtubeUrl: null, thumbnailUrl: null },
  { id: 2, title: '메이첼', animalName: '메이첼', youtubeUrl: null, thumbnailUrl: null },
  { id: 3, title: '시베리아', animalName: '시베리아', youtubeUrl: null, thumbnailUrl: null },
  { id: 4, title: '마티', animalName: '마티', youtubeUrl: null, thumbnailUrl: null },
  { id: 5, title: '미애', animalName: '미애', youtubeUrl: null, thumbnailUrl: null },
  { id: 6, title: '미첼', animalName: '미첼', youtubeUrl: null, thumbnailUrl: null },
  { id: 7, title: '잭슨', animalName: '잭슨', youtubeUrl: null, thumbnailUrl: null },
  { id: 8, title: '쭈니', animalName: '쭈니', youtubeUrl: null, thumbnailUrl: null },
];
...
export default function GalleryEmbedPage() {
  ...
  const { data: videos = FALLBACK_VIDEOS } = useQuery({
    queryKey: [...queryKeys.videos.list({ sort }), 'embed'],
    queryFn: () => getVideosEmbed({ sort }),
  });
      ...
      <div className="max-w-5xl mx-auto px-6 pt-8">
        ...
        {videos.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-muted">
            ...
            <p className="text-sm">아직 등록된 영상이 없어요</p>
            <button
