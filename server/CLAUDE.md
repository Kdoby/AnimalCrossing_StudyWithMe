...
- **CRITICAL: NEVER use emojis, decorative icons, or unnecessary symbols (e.g., 🚀, ✨, 🔨, ✅, ❌) in code, shell commands, commit messages, or terminal responses.**
- Maintain a clean, professional, and purely text-based output.
